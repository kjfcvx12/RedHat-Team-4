...
const Login = () => {
    ...
    const userLogin = (e) => {   //form제출시 새로고침 방지
        ...
        if (loginUser) {    //context에 로그인정보 저장
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-b from-sky-50 via-gray-50 to-white flex items-center justify-center px-4">
            <form
                onSubmit={userLogin}
                className="w-full max-w-md bg-white shadow-lg rounded-2xl p-8 text-gray-800 border border-gray-100"
            >
                <div className="mb-8 pb-4 border-b border-gray-100">
                    <p className="text-sm font-semibold text-sky-400 mb-2">Welcome Back!</p>
                ...
                <div className="space-y-5">
                    <input
                        ...
                        placeholder="아이디 입력"
                        className="w-full px-4 py-3 text-sm text-gray-700 border border-gray-200 rounded-lg outline-none bg-white focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-all"
                    />
                    <input
                        type="password"
                        value={pw}
                    ...
                    <button
                        type="submit"
                        className="w-full py-3 bg-sky-400 text-white text-sm font-semibold rounded-lg hover:bg-sky-500 transition-colors shadow-sm"
                    >
                        로그인
                    </button>
                </div>
