...
const Board = () => {
        ...
        useEffect(()=>{
            ...
            if(currnetPost){
                setPost(currnetPost);
                setLike(currnetPost.like||0);
                setHate(currnetPost.hate||0);
            }
        },[id])
        ...
        return (
            <div>
                ...
                <button onClick={()=>{
                    ...
                    disabled={isHate}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
